...
export declare class PostService {
    ...
    private readonly taggedPostService;
    private readonly pythonService;
    private readonly s3Service;
    private readonly postReactionService;
    private readonly userPostReactionService;
    constructor(PostModel: ModelType<PostModel>, UserModel: ModelType<UserModel>, graphService: GraphService, postTagService: PostTagService, taggedPostService: TaggedPostService, pythonService: PythonService, s3Service: S3Service, postReactionService: PostReactionService, userPostReactionService: UserPostReactionService);
    ...
    getPosts(skip: any, userId?: Types.ObjectId): Promise<any[]>;
}
